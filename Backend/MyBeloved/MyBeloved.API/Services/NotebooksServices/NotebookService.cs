...
namespace MyBeloved.API.Services.NotebooksServices
{
    public class NotebookService : INotebookService
    {
        ...
        private readonly ValidationEmptyOrNull<Notebook> _validation = new ValidationEmptyOrNull<Notebook>();
        ...
        public async Task<Response<List<Notebook>>> DeleteNotebookById(int id)
        {
            ...
            try
            {
                ...
                response = _validation.MultipleCheckIfNullOrEmpty(notebook);
                if (!response.Success)
                {
                    return response;
                }
